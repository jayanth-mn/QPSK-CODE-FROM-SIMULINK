...
HD_PWD='C:/Users/Jayanth MN/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log qpsk1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source qpsk1.tcl -notrace
